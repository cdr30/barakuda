...
cf_nemo_moc1 = DIAG_DIR+'/'+CONFRUN1+'/clim/aclim_'+CONFRUN1+'_'+cy1_1+'-'+cy2_1+'_MOC.nc4' ; bt.chck4f(cf_nemo_moc1)
cf_nemo_moc2 = DIAG_DIR+'/'+CONFRUN2+'/clim/aclim_'+CONFRUN2+'_'+cy1_2+'-'+cy2_2+'_MOC.nc4' ; bt.chck4f(cf_nemo_moc2)


id_nemo_moc1 = Dataset(cf_nemo_moc1)
Amoc1   = id_nemo_moc1.variables[bo.cv_amoc][:,:,:]
...
Amoc2   = id_nemo_moc2.variables[bo.cv_amoc][:,:,:]
id_nemo_moc2.close()
...
cf_nemo_mnmc1 = DIAG_DIR+'/'+CONFRUN1+'/clim/mclim_'+CONFRUN1+'_'+cy1_1+'-'+cy2_1+'_grid_T.nc4'; bt.chck4f(cf_nemo_mnmc1)
cf_nemo_mnmc2 = DIAG_DIR+'/'+CONFRUN2+'/clim/mclim_'+CONFRUN2+'_'+cy1_2+'-'+cy2_2+'_grid_T.nc4'; bt.chck4f(cf_nemo_mnmc2)

id_nemo_mnmc1 = Dataset(cf_nemo_mnmc1)
Tnemo1  = id_nemo_mnmc1.variables[bo.cv_temp][:,:,:,:]
Snemo1  = id_nemo_mnmc1.variables[bo.cv_sali][:,:,:,:]
...
Tnemo2  = id_nemo_mnmc2.variables[bo.cv_temp][:,:,:,:]
Snemo2  = id_nemo_mnmc2.variables[bo.cv_sali][:,:,:,:]
id_nemo_mnmc2.close()
...
ji30W = bt.find_index_from_value( -30., xlon[0,:] ) ; lon30W = xlon[0,ji30W]; print ' ji30W =', ji30W, lon30W

lat_max_north = 40.



bp.plot("vert_section")(xlat[:,ji30W], vdepth, nmp.mean(Tnemo1[:,:,:,ji30W],axis=0),
...
bp.plot("vert_section")(xlat[:,ji30W], vdepth, nmp.mean(Snemo2[:,:,:,ji30W],axis=0) - nmp.mean(Snemo1[:,:,:,ji30W],axis=0),
